...
/**
  * CallsModel for Scala 2.10
  */
object CallsModel210 {
    ...
    def apply (str: String): Option[CallEvent] = {
      ...
      scala.util.Try (
        ...
        new CallEvent (
          ...
          scala.util.Try (new java.sql.Timestamp(org.joda.time.LocalDateTime.parse (paramArray(3)).toDateTime().getMillis())).toOption,
          ...
          scala.util.Try (paramArray(14).toDouble).toOption,
